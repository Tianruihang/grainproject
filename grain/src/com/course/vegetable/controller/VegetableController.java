...
//		v.setVegetablePicture(vpicture);
	...
	public String list(@RequestParam(name="pageNum",defaultValue="1")int pageNum,
		...
		@RequestMapping(value="deleteyhVegetable")
		public String deleteyh(@RequestParam("vegetableId") int vegetableId,
				HttpServletRequest request){
			this.vegetableServiceImpl.dropVegetable(vegetableId);
			return "redirect:chankanyh";
		}
		@RequestMapping(value="deletetejiayhVegetable")
		public String deletetejiayh(@RequestParam("vegetableId") int vegetableId,
				HttpServletRequest request){
			this.vegetableServiceImpl.dropVegetable(vegetableId);
			return "redirect:tejiayh";
		}
		@RequestMapping(value="deletetejiaVegetable")
		public String deletetejia(@RequestParam("vegetableId") int vegetableId,
				HttpServletRequest request){
			this.vegetableServiceImpl.dropVegetable(vegetableId);
		...
		public String chakanyh(@RequestParam(name="pageNum",defaultValue="1")int pageNum,
			...
			if (searchParam==null || "".equals(searchParam)) {
				...
				request.setAttribute("page", page);
				request.setAttribute("searchParam", searchParam);
				return "files/shangpinguanliyh-vegetable";
		...
		public String tejiayh(@RequestParam(name="pageNum",defaultValue="1")int pageNum,
			...
			if (searchParam==null || "".equals(searchParam)) {
				...
				request.setAttribute("page", page);
				request.setAttribute("searchParam", searchParam);
				return "files/tejiashangpinyh-vegetable";
		...
		public String tejia(@RequestParam(name="pageNum",defaultValue="1")int pageNum,
			...
			if (searchParam==null || "".equals(searchParam)) {
				...
				request.setAttribute("page", page);
				request.setAttribute("searchParam", searchParam);
				return "files/tejiashangpin-vegetable";
